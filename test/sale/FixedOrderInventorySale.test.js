...
describe('FixedOrderInventorySale', function () {
    ...
    async function doDeployErc20(overrides = {}) {
        ...
        await this.erc20.transfer(
            overrides.purchaser || purchaser,
            overrides.purchaserErc20Balance || purchaserErc20Balance,
            { from: overrides.from || deployer }
        );

        await this.erc20.transfer(
            overrides.recipient || recipient,
            overrides.recipientErc20Balance || recipientErc20Balance,
            { from: overrides.from || deployer }
        );
    }

    async function doDeployInventory(overrides = {}) {
        this.inventory = await Inventory.new(
            overrides.nfMaskLength || nfMaskLength,
            { from: overrides.from || deployer }
        );
    ...
    async function doUpdateSkuPricing(overrides = {}) {
        await this.sale.updateSkuPricing(
            overrides.sku || sku,
            [ overrides.erc20Address || this.erc20.address ],
            [ overrides.erc20Price || erc20Price ],
            { from: overrides.from || deployer }
        );
    }
    ...
    describe('constructor', function () {
        ...
        describe('when `inventory_` is the zero address', function () {
            ...
            it('reverts', async function () {
                await expectRevert(
                    doDeploySale.bind(this)({ inventory: ZeroAddress }),
    ...
    describe('addSupply()', function () {
        ...
        describe('when called by any other than the contract owner', function () {
            ...
            it('reverts', async function () {
                await expectRevert(
                    this.sale.addSupply(tokens, { from: other }),
        ...
        describe('when `tokens` is empty', function () {
            ...
            it('reverts', async function () {
                await expectRevert(
                    this.sale.addSupply([], { from: deployer }),
        ...
        describe('when any of `tokens` are zero', function () {
            ...
            it('reverts', async function () {
                await expectRevert(
                    this.sale.addSupply([ token4, Zero, token5 ], { from: deployer }),
    ...
    describe('setSupply()', function () {
        ...
        context('when called by any other than the contract owner', function () {
            ...
            it('reverts', async function () {
                await expectRevert(
                    this.sale.setSupply([ 0 ], [ token2 ], { from: other }),
                    "Ownable: caller is not the owner"
                );
            });
        ...
        context('when the contract is not paused', function () {
            ...
            it('reverts', async function () {
                ...
                await expectRevert(
                    this.sale.setSupply([ 0 ], [ token2 ], { from: deployer }),
                    "Pausable: not paused"
                );
            });
        ...
        context('when the token list is initialized', function () {
            ...
            describe('when the lengths of `indexes` and `tokens` do not match', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.sale.setSupply([ 0 ], [ token2, token3 ], { from: deployer }),
            ...
            describe('when `indexes` is zero length', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.sale.setSupply([], [ token2 ], { from: deployer }),
            ...
            describe('when any of `indexes` are out-of-bounds', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.sale.setSupply([ tokens.length ], [ token2 ], { from: deployer }),
            ...
            describe('when `tokens` is zero length', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.sale.setSupply([ 0 ], [], { from: deployer }),
                        "FixedOrderInventorySale: array length mismatch"
                    );
                });
            ...
            describe('when any of `tokens` are zero', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.sale.setSupply([ 0, 1, 2 ], [ token2, Zero, token1 ], { from: deployer }),
