...
// /**
//  * @title KyberLotSale
//  * An abstract fixed supply lot sale contract that uses Kyber token swaps to accept supported ERC20 tokens as purchase payments.
//  */
...
//     )
//         internal
//         FixedSupplyLotSale(fungibleTokenId, inventoryContract)
//         KyberPayment(payoutWallet_, payoutToken_, kyberProxy)
//     {}
...
//      */
//     function _calculatePrice(Purchase memory purchase)
//         internal
//         virtual
//         override
//         view
...
//      *  received (uint256)).
//      */
//     function _transferFunds(Purchase memory purchase, bytes32[] memory priceInfo)
//         internal
//         virtual
//         override
//         returns (bytes32[] memory paymentInfo)
//     {
...
//         paymentInfo = _handlePaymentTransfers(purchase.operator, purchase.paymentToken, maxTokenAmount, extData);
//     }
...
//     ) internal virtual override view returns (bytes32[] memory totalPriceInfo) {
...
//         totalPriceInfo = _handlePaymentAmount(payoutToken, payoutAmount, extData);
//     }
// }
